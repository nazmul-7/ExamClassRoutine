...
INSERT INTO `products` (`id`, `title`, `description`, `price`, `city`, `state`, `zip_code`, `status`, `category_id`, `hands`, `color`, `breed`, `gender`, `age`, `horses_name`, `view_count`, `created_at`, `updated_at`) VALUES
(1, 'demoooo', 'demo table card-table table-bordered table-hover table-vcenter text-nowrap', 123, 'demo', 'demo', 123, 'Pending', 1, 'demo', 'demo', 'demooooooo  444', 'demo', 21, 'demo', 0, NULL, NULL);
...
(1, 'Admin', 'admin@gmail.com', '$2y$10$1QcTYDXyK55zjpG6Y1JAoujZ.Kxk5BX9nNKO2Xe6A/m5ILpC2zOIa', 'Admin', '026387332', '', '', '', 0, NULL, NULL),
